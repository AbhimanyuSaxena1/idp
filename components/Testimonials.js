      ...
      >
        <SwiperSlide className="swiper-slide ">
          <blockquote className="mil-with-bg">
            ...
            <p className="mil-text-m  !text-black mil-mb-30 mil-up">
            ...
            <div className="mil-customer">
              ...
              <h6 className="mil-up !text-black">Rüdiger Karlsen</h6>
            </div>
          </blockquote>
        </SwiperSlide>
        <SwiperSlide className="swiper-slide">
          <blockquote className="mil-with-bg">
            ...
            <div className="mil-customer">
              ...
              <h6 className="mil-up !text-black">Branka Berg</h6>
            </div>
          </blockquote>
        </SwiperSlide>
        <SwiperSlide className="swiper-slide">
          <blockquote className="mil-with-bg">
            ...
            <div className="mil-customer">
              ...
              <h6 className="mil-up !text-black">Karl Andreassen</h6>
            </div>
          </blockquote>
        </SwiperSlide>
        <SwiperSlide className="swiper-slide">
          <blockquote className="mil-with-bg">
            ...
            <div className="mil-customer">
              <img src="img/faces/2.jpg" alt="Customer" className="mil-up" />
              <h6 className="mil-up !text-black">Bett Nilsen</h6>
            </div>
          </blockquote>
        </SwiperSlide>
      </Swiper>
