  ...
  return (
    <div className={`mil-top-panel ${dark ? "mil-dark-2" : ""}`}>
      <div className="container">
        <Link href="/" className="mil-logo flex items-center">
          <img
            src={dark ? "img/logo-light.png" : "img/indhanpay_logo.png"}
            alt="Plax"
            width={70}
            height={70}
          />
          <h1 className="!text-sm !text-yellow-500 sm:text-2xl md:!trxt-2xl xl:!text-2xl lg:!text-2xl ">InDhan <span className="!text-black">Pay</span> </h1>
        </Link>
