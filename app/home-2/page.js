...
const page = () => {
  return (
    <PlaxLayout bg={false}>
      <Banner
        title="Collect Efficiently, Provide Service"
        img="img/home-1/indhanpay_website_2.png"
        style={{ maxWidth: "125%", transform: "translateX(10%)" ,transform:"translateY(30%)"}}
      />
      {/* banner end */}
      {/* features */}
          ...
          <div className="row flex-sm-row-reverse justify-content-between align-items-center">
            <div className="col-xl-6 mil-mb-80">
              <h2 className="mil-mb-30 mil-up">
                ...
                Using <span className="!text-[#FFB200] md:italic xl:italic lg:italic text-6xl"> Indhan</span><span className="md:italic lg:italic xl:italic text-6xl">Pay</span><sup className="italic lg:ml-2 md:ml-2 xl:!ml-2">®</sup>
              </h2>
            ...
            <div className="col-xl-5 mil-mb-80">
              <div className="mil-image-frame mil-visible-overflow">
                <img src="img/home-1/1040X1460.png" alt="image" className="mil-up" />
              ...
              <div className="row">
                <div className="col-xl-6 mil-sm-text-center mil-mb-30 mil-up">
                  <p className="h1 mil-display mil-mb-15">
                    <span className="mil-accent mil-counter" data-number={14}>
                      14
                    </span>
                    <span className="mil-pale"></span>
                  </p>
                  <h5>Registered R/O</h5>
                </div>
                <div className="col-xl-6 mil-sm-text-center mil-mb-80 mil-up">
                  <p className="h1 mil-display mil-mb-15">
                    <span className="mil-accent mil-counter" data-number={1400}>
                      1400
                    </span>
                    <span className="mil-pale">+</span>
                  </p>
                  <h5>Handling customers Daily</h5>
                </div>
              </div>
            </div>
            <div className="col-xl-5 mil-mb-80">
          ...
          <div className="row justify-content-center">
            <div className="col-6 col-md-2 mil-text-center">
              <div className="mil-brand">
                <img src="img/brands/1.png" alt="JJShri" className="mil-up" />
              </div>
            </div>
            <div className="col-6 col-md-2 mil-text-center">
              <div className="mil-brand">
                <img src="img/brands/2.png" alt="brand" className="mil-up" />
              </div>
            </div>
            <div className="col-6 col-md-2 mil-text-center">
              <div className="mil-brand">
                <img src="img/brands/3.png" alt="brand" className="mil-up" />
              </div>
            </div>
            <div className="col-6 col-md-2">
              <div className="mil-brand mil-text-center">
                <img src="img/brands/4.png" alt="brand" className="mil-up" />
              </div>
            </div><div className="col-6 col-md-2">
              <div className="mil-brand mil-text-center">
                <img src="img/brands/5.png" alt="brand" className="mil-up" />
              </div>
            </div><div className="col-6 col-md-2">
              <div className="mil-brand mil-text-center">
                <img src="img/brands/6.png" alt="brand" className="mil-up" />
              </div>
            </div>
          </div>
        </div>
