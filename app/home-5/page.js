            ...
            <div className="row flex-sm-row-reverse justify-content-between align-items-center">
              <div className="col-xl-5 mil-mb-60">
                <h2 className="mil-mb-30 mil-light mil-up">
                  Accept Fuel Payments & reconcile with ease
                </h2>
              ...
              <div className="col-xl-6">
                <img
                  src="https://indhanpay-public.s3.ap-south-1.amazonaws.com/common_file/indhan.gif"
                  // img/home-5/2.png
                  alt="img"
                  style={{ width: "100%" }}
                  className="mil-up"
        ...
        <div className="container">
          <div className="mil-out-frame mil-image-2 mil-bg-2">
            <div className="row justify-content-center align-items-center mil-p-160-0">
              <div className="col-xl-7 mil-text-center">
                <h2 className="mil-light mil-mb-30 mil-up">
                  Collect & Reconcile Money <br />
                  Move with InDhanPay App
                </h2>
                <p className="mil-text-l mil-light mil-mb-60 mil-up">
                  Discover the convenience of reconciliation from the palm of your hand
                  and experience collection on the go quickly and securely.
                </p>
                <div className="mil-buttons-frame mil-center mil-mb-60 mil-up">
                  <a href="https://play.google.com/store/apps/details?id=com.indhanpay.app&hl=en_IN" className="mil-btn mil-md">
